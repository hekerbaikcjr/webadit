...
$ambildata = mysqli_query(
    $koneksi,
    "SELECT * FROM rka WHERE id_rka='$id_rka'"
);
        ...
        <div class="card-body">
          ...
          <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-10">
                <input type="text" name="tanggungjawab" class="form-control" id="tanggungjawab" value="<?php echo $data[
                                "tanggungjawab"
                            ]; ?>">
              </div>
            </div>
          ...
          <?php if (isset($_POST["submit"])) {
                          ...
                          $query = "UPDATE rka SET nama_file ='$nama_file', tanggal='$tanggal', tanggungjawab ='$tanggungjawab', bidang='$bidang' WHERE id_rka = '$id_rka'";
